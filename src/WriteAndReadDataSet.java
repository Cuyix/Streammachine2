...
public class WriteAndReadDataSet implements StreamReadWrite {
    public static void main(String[] args) {
        ...
        // TODO: Neuer Input nicht Anwendbar - Wie Strukturieren und Umgehen?
        ...
        try {
            ...
            ps.print(input);
            numberOfBytesinString = input.getBytes().length;
/*            for (int i = 0; i < 3; i++) {
